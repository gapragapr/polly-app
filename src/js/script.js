export default class NailsClass{
    ...
    drawClients(item){
        ...
        const images = {
            homeImage: './assets/img/home.svg',
            workImg: './assets/img/work.svg',
            deleteImage: './assets/img/delete-svgrepo-com.svg',
            whitePawImage: './assets/img/pawprint-cat-svgrepo-com.svg',
            blackPawImage: './assets/img/pawprint-cat-svgrepo-com (1).svg' 
        };
